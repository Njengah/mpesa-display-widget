...
The Supported payments display Widget is a simple yet powerful WordPress plugin that allows you to showcase your payment details effortlessly. Whether you're running a business or accepting donations, this plugin makes it convenient to display your payment number on your website.

## Features

- Easy setup and configuration
- Display your Till or Paybill number on your website
...
7. Go to the "Appearance" -> "Widgets" section to add and configure the Till or Paybill Display Widget in your desired widget area.

## Configuration

1. In your WordPress admin panel, go to "Appearance" -> "Widgets".
2. Locate the "Till or Paybill Display Widget" and drag it to your desired widget area.
3. Enter your supported payments number in the widget settings.
